        ...
        <div class="container-fluid-lg">
            <div class="slider-4-banner no-arrow slick-height">
                ...
                <div>
                    <div class="banner-contain-3 hover-effect">
                        <a href="javascript:void(0)">
                            <img src="../assets/images/grocery/banner/3.jpg" class="img-fluid bg-img"
                                alt="" />
                        </a>
                        <div class="banner-detail p-center-left w-75 banner-p-sm mend-auto">
                            <div>
                ...
                <div>
                    <div class="bank-offer">
                        <div class="bank-header">
                            <div class="bank-left w-100">
                                <div class="bank-image">
                                    <img src="../assets/images/grocery/bank/name/1.png" class="img-fluid"
                                        alt="" />
                                </div>
                                <div class="bank-name">
                                    <h2>GET 10% OFF</h2>
                            ...
                            <div class="bank-right w-100">
                                <img src="../assets/images/grocery/bank/price/1.svg" class="img-fluid"
                                    alt="" />
                            </div>
                        </div>
                        ...
                        <div class="bank-footer bank-footer-1">
                            ...
                            <button type="button" class="bank-coupon btn" id="copyText"
                                data-clipboard-action="copy" data-clipboard-target="#clipboardexample">
                                Copy Code
                            </button>
                        </div>
                    </div>
                ...
                <div>
                    <div class="bank-offer">
                        <div class="bank-header">
                            <div class="bank-left w-100">
                                <div class="bank-image">
                                    <img src="../assets/images/grocery/bank/name/2.png" class="img-fluid"
                                        alt="" />
                                </div>
                                <div class="bank-name">
                            ...
                            <div class="bank-right w-100">
                                <img src="../assets/images/grocery/bank/price/2.svg" class="img-fluid"
                                    alt="" />
                            </div>
                        </div>
                        ...
                        <div class="bank-footer bank-footer-2">
                            ...
                            <button class="bank-coupon btn" id="copyText1">
                                Copy Code
                            </button>
                        </div>
                    </div>
                ...
                <div>
                    <div class="bank-offer">
                        <div class="bank-header">
                            <div class="bank-left w-100">
                                <div class="bank-image">
                                    <img src="../assets/images/grocery/bank/name/3.png" class="img-fluid"
                                        alt="" />
                                </div>
                                <div class="bank-name">
                            ...
                            <div class="bank-right w-100">
                                <img src="../assets/images/grocery/bank/price/3.svg" class="img-fluid"
                                    alt="" />
                            </div>
                        </div>
                        ...
                        <div class="bank-footer bank-footer-3">
                            ...
                            <button class="bank-coupon btn" id="copyText2">
                                Copy Code
                            </button>
                        </div>
                    </div>
                ...
                <div>
                    <div class="bank-offer">
                        ...
                        <div class="bank-footer bank-footer-1">
                            ...
                            <button class="bank-coupon btn" id="copyText3">
                                Copy Code
                            </button>
                        </div>
                    </div>
                            ...
                            <div class="top-selling-slider product-arrow">
                                <div>
                                    ...
                                    <div class="product-detail text-center">
                                        ...
                                        <h5 class="text-content">
                                            Solid : <span class="text-dark">30 items</span>
                                ...
                                <div>
                                    ...
                                    <div class="product-detail text-center">
                                        ...
                                        <a href="product-left-thumbnail.html">
                                            <h3 class="name w-100 mx-auto text-center text-title">
                                                Unisex Small Trolley Suitcase
                                            </h3>
                                        </a>
                                        <h3 class="price theme-color d-flex justify-content-center">
        ...
        <div class="container-fluid-lg">
            <div class="row gy-lg-0 gy-3">
                <div class="col-lg-6">
                    <div class="banner-contain-3 hover-effect">
                        <div>
                            <img src="../assets/images/grocery/banner/6.jpg" class="bg-img blur-up lazyload"
                                alt="" />
                            <div
                                class="banner-detail banner-detail-2 text-dark p-center-left w-75 banner-p-sm position-relative mend-auto">
                                <div>
                                    <h2 class="text-great fw-normal text-danger">
                                        50% special offer
                                    </h2>
                                    <h3 class="mb-1 fw-bold">
                                        Chocolate Shake Back in <br class="d-sm-block d-none" />
                                        Stock
                                    </h3>
                                    <h4 class="text-content">Offer Of the Week!</h4>
                                    <button
                                        class="btn btn-md theme-bg-color text-white mt-sm-3 mt-1 fw-bold mend-auto"
                                        onclick="location.href = 'shop-left-sidebar.html';">
                                        Shop Now
                                    </button>
                                </div>
                ...
                <div class="col-lg-6">
                    <div class="banner-contain-3 hover-effect">
                        <img src="../assets/images/grocery/banner/7.jpg" class="bg-img blur-up lazyload"
                            alt="" />
                        <div
                            class="banner-detail banner-detail-2 text-dark p-center-left w-75 banner-p-sm position-relative mend-auto">
                            <div>
                                ...
                                <h3 class="mb-1 fw-bold">
                                    Healthy & Fresh Cool <br />
                                    Breakfast
                                </h3>
                                <h4 class="text-content">
                                    Choose a Nutritious & Healthy Breakfast.
                                </h4>
            ...
            <div class="row gy-lg-0 gy-3">
                <div class="col-lg-8">
                    <div class="banner-contain-3 h-100 pt-sm-5 hover-effect">
                        <img src="../assets/images/grocery/banner/8.png" class="bg-img blur-up lazyload"
                            alt="" />
                        <div
                            class="banner-detail banner-p-sm p-center-right position-relative banner-minus-position banner-detail-deliver">
                            <div>
                                <h3 class="fw-bold banner-contain">
                                    Safe Delivery to the door
                                </h3>
                                <h4 class="mb-sm-3 mb-2 delivery-contain">
